...
import icSelect from 'public/img/icSelect.png'
import icNotSelect from 'public/img/icNotSelect.png'
...
const AddressEdit = () => {
  ...
  const [isPickerShow, setIsPickerShow] = useState(false) // 地址选择器弹层显示状态
    ...
    return (
      <div className={s.addressForm}>
        ...
        <div className={s.defaultAddress}>
          <img className={s.icon} src={isDefault ? icSelect : icNotSelect} alt={''} />
          设为默认地址
        </div>
      </div>
    )
